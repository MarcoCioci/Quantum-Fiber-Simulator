...
%   numerical tolerance. If all checks pass, a success message is printed.
    ...
    assert(abs(purity_pure - 1.0) < tol, ...
    ...
    assert(abs(purity_mixed_qubit - 0.5) < tol, ...
    ...
    assert(abs(purity_bell_global - 1.0) < tol, ...

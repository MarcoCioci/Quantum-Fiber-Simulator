...
% % ==========================================
%     results_experiment_1 = run_experiment_1_phase_baseline_sweep([], do_summary_plot, do_tensor_plot, do_save);

% % ==========================================
% % Experiment 2 - Random Phase Ensemble State
% % ==========================================
%     results_experiment_2 = run_experiment_2_random_phase([], do_summary_plot, do_tensor_plot, do_save);

% % ==========================================
% % Experiment 3 - Random Phase Ensemble State
% % ==========================================
%     results_experiment_3 = run_experiment_3_depolarization([], do_summary_plot, do_save);

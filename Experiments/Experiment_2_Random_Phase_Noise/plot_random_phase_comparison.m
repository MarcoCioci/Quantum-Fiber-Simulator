...
% PLOT_RANDOM_PHASE_COMPARISON  Experiment 2 validation with separated views.
%
% Objective:
%   Provide a clearer visualization of Experiment 2 by separating:
%
...
%
%   This visualization is intentionally different from Experiment 1 because
%   Experiment 2 does not produce correlation curves versus theta. It
%   produces a single ensemble-averaged output state.
    ...
    % Show summary statistics in the title area using text box inside axes
    ...
    % Add numeric values above / below bars
    for k = 1:3

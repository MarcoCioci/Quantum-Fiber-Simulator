...
%   None
    ...
    build_phase_baseline_state_metrics_plot(tab, data, style, palette);
    ...
    if do_save
        ...
        export_plot(output_path, ...
            @(parent) build_phase_baseline_state_metrics_plot(parent, data, style, palette), ...
            style);
    end
...
function tl = build_phase_baseline_state_metrics_plot(parent, data, style, palette)
...
%   tl - tiledlayout handle
    ...
    title(tl, ...
        'Experiment 1 — State Metrics | deterministic phase sweep', ...

...
%   structure is encoded in the correlation tensor T.
    ...
    figure('Name', 'Experiment 4 — Local CHSH Axes on Bloch Spheres', ...
           'Color', 'w');
    ...
    draw_axis_arc(a1, a2, palette.blue, palette.orange);

    title('Subsystem A measurement axes');
    xlabel('x');
    ylabel('y');
    zlabel('z');
    ...
    draw_axis_arc(b1, b2, palette.green, palette.red);

    title('Subsystem B measurement axes');
    xlabel('x');
    ylabel('y');
    zlabel('z');
    ...
    sgtitle('Experiment 4 — Fixed Local CHSH Measurement Axes', ...
        'FontWeight', 'bold');
...
function draw_axis_arc(axis_1, axis_2, color_1, color_2)

...
However, in this context, \( \sigma_y \) is not used as a measurement operator associated with the physical \( Y \)-axis. Instead, it appears because it realizes the invariant antisymmetric structure of two-dimensional spinor spaces.

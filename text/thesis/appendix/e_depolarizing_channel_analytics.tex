%========================================================
% APPENDIX E — Depolarizing Channel Analytics
%========================================================

\chapter{Depolarizing Channel Analytics}
\label{app:depolarizing_channel_derivations}

This appendix derives the analytical expressions used to validate the depolarizing-channel experiment in Section~\ref{sec:depolarizing_channel}.
...
%--------------------------------------------------------
% E.1 - Density matrix representation
%--------------------------------------------------------
...
\section*{Fidelity with respect to \texorpdfstring{\( |\Psi^+\rangle \)}{|Psi+>}}
...
%--------------------------------------------------------
% E.7 - Correlation tensor
%--------------------------------------------------------

\section*{Correlation tensor}

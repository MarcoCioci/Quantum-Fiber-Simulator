...
increasingly important requirement in information technology. Optical fibers represent a
...
for long-distance photonic links~\cite{wehner_elkouss_hanson_quantum_internet_2018, abadal2024electromagnetic}.
...
entanglement-based quantum communication protocols~\cite{bennett_brassard_mermin_BBM92_1992}. Their transmission through real optical
fibers, however, is affected by birefringence, polarization rotations, phase
accumulation, temporal effects, and environmental fluctuations~\cite{dowling_2023_polarization_control}. While deterministic local
...
decoherence and degrade the polarization correlations accessible at the receiver~\cite{poon_law_stochastic_pmd_2008,
...
establish a secure key~\cite{bennett_brassard_mermin_BBM92_1992}. Fiber propagation and environmental
...
state quality, coherence, entanglement. Particular attention is
...
dispersion (PMD)~\cite{riccardi_polarization_entanglement_distribution_2021,
...
Chapter~\ref{ch:03_numerical_simulations_results} describes the implementation of the developed 
models in a modular MATLAB simulation framework. It investigates through numerical
...
regions of parameter space in which the distributed state satisfies selected
state-quality and BBM92-oriented operational criteria, assess the validity of
reduced models against the physical frequency-dependent description, and relate
the resulting entanglement degradation to protocol-relevant quantities such as
the QBER.
...
the experimental activity is therefore intended as an exploration of the
conditions of propagation in the fiber links rather than as a complete BBM92 implementation.

...
\section{Experiment 1: Single-Segment PMD and the Bandwidth--DGD Regime}
\label{sec:experiment_1_single_segment_pmd}
\input{chapters/numerical_experiments/03_1_single_segment_pmd}


\section{Experiment 2: Two-Arm PMD and Spectral Correlations}
\label{sec:experiment_2_two_arm_pmd_spectral_correlations}
\input{chapters/numerical_experiments/03_2_two_arm_pmd_spectral_correlations}

% \input{chapters/numerical_experiments/03_4_statistical_segmented_fiber}

% \input{chapters/numerical_experiments/03_5_fiber_parameter_entanglement_maps}

% \input{chapters/numerical_experiments/03_6_pmd_compensation_robustness}

% \input{chapters/numerical_experiments/03_7_effective_model_comparison}

% \input{chapters/numerical_experiments/03_8_experimental_implications}